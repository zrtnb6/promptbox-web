...
[![Deploy to Cloudflare Pages](https://img.shields.io/badge/Deploy%20to-Cloudflare%20Pages-F38020?style=for-the-badge&logo=cloudflare)](https://dash.cloudflare.com/?to=/:account/workers-and-pages/create/deploy-to-pages&repository=https://github.com/zrtnb6/promptbox&branch=main)
...
> ☁️ 本仓库为**纯 Web 版本**，不含桌面端（Tauri）代码。桌面客户端为作者自用，不在此公开。
...
```
https://dash.cloudflare.com/?to=/:account/workers-and-pages/create/deploy-to-pages&repository=https://github.com/zrtnb6/promptbox&branch=main
```
...
4. 授权 GitHub 后，在仓库列表里粘贴 / 选择本仓库链接：
   ```
   https://github.com/zrtnb6/promptbox
   ```
