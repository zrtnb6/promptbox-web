...
const PATHS: Record<string, string[]> = {
  ...
  // 整体下移 0.5：原路径含弧顶只占 y 2.879~20，视觉偏上，居中后与 trash 齐平
  pencil: ['M12 20.5h9', 'M16.5 4a2.121 2.121 0 0 1 3 3L7 19.5l-4 1 1-4z'],
  play: ['M6 4l14 8-14 8z'],
  // 整体上移 0.5：原路径占 y 3~22，视觉偏下
  trash: [
    'M3 5.5h18',
    'M8 5.5V3.5a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2',
    'M19 5.5l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 5.5',
  ],
